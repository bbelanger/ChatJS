...
class MessageBoardOptions {
    ...
    playSound: boolean;
    // path to the root content folder
...
class MessageBoard {
    ...
    playSound() {
        ...
        $soundContainer.html('<audio autoplay="autoplay"><source src="' + + '.mp3" type="audio/mpeg" /><source src="' + baseFileName + '.ogg" type="audio/ogg" /><embed hidden="true" autostart="true" loop="false" src="' + baseFileName + '.mp3" /></audio>');
    }
